...
* Fixed "Uncaught TypeError" when data-original is null. Instead it'll trigger the `error` callback.
...
* Added new option, `separator`. Used if you want to pass retina images, default separator is ‘|’. (data-original=“image.jpg|image&#64;2x.jpg”).
