...
<%--
				...
				<section id="grid" class="grid clearfix">
					<a href="#" data-path-hover="m 180,34.57627 -180,0 L 0,0 180,0 z">
						<figure>
							...
							<figcaption>
								<h2>Scope</h2>
								<p>Etiam porta sem malesuada magna euismod.</p>
								<button>View</button>
							</figcaption>
						</figure>
					</a>
					...
					<a href="#" data-path-hover="m 180,34.57627 -180,0 L 0,0 180,0 z">
						<figure>
							...
							<figcaption>
								...
								<p>Aenean eu leo quam sem lacinia venenatis vestibulum.</p>
								<button>View</button>
							</figcaption>
						</figure>
					</a>
	...
	<section class="fixed bg1" data-bottom-top="background-position: 50% 100%"  data-top-bottom="background-position: 50% 0%">
		<div class="photo-text" data-bottom-top="background-color:rgba(0,0,0,0);" data-top-bottom="background-color:rgba(0,0,0,1);">
			<div class="inner">
				<h1 class="section-title">Health &amp; Safety</h1>
				<p class="section-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sed odio dui. Sed posuere consectetur est at lobortis. Morbi leo risus, porta ac consectetur.</p>
				<section id="grid" class="grid clearfix">
					<a href="#" data-path-hover="m 180,34.57627 -180,0 L 0,0 180,0 z">
						<figure>
					...
					<a href="#" data-path-hover="m 180,34.57627 -180,0 L 0,0 180,0 z">
						<figure>
							...
							<figcaption>
								...
								<p>Etiam porta malesuada magna mollis euismod.</p>
								<button>View</button>
							</figcaption>
						</figure>
					</a>
	...
	<section class="latest-news">
		<div class="container">
			...
			<ul class="unstyled justify justify-3">
				<li class="justify-item">
					<h2 class="news-title">One UI student is bringing the fashion industry to Iowa City</h2>
					<div class="news-desc">
						<p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Curabitur blandit tempus porttitor. Donec sed odio dui.</p>
						<p class="news-date">Feb. 3</p>
					</div>
				</li>
				<li class="justify-item">
					<h2 class="news-title">One UI student is bringing the fashion industry to Iowa City</h2>
