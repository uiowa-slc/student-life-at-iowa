...
<section class="yir-section">
	<div class="row">
		<div class="columns small-12 large-6">
			...
			<div>
				<p>Nulla vitae elit libero, a pharetra augue. Maecenas sed diam eget risus varius blandit sit amet non magna. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Cras mattis consectetur purus sit amet fermentum.</p>
				<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec ullamcorper nulla non metus auctor fringilla. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Morbi leo risus, porta ac consectetur ac, vestibulum at eros...</p>
				<div class="slidetext" style="display:none;">
					<p>Vestibulum id ligula porta felis euismod semper. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Nullam quis risus eget urna mollis ornare vel eu leo.</p>
					<p>Curabitur blandit tempus porttitor. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec sed odio dui. Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit sit amet non magna. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras mattis consectetur purus sit amet fermentum.</p>
				</div>
				<hr class="large" />

				<button class="toggletext" data-content="toggle-text">Read More</button>
			</div>
		</div>
	...
	<div style="position: relative;">
		<div class="row">
			<div class="columns small-12 large-3">
				<h3 class="header--caps">Key Statistics</h3>
			</div>
			<div class="columns small-12 large-9">
				<p class="ptext">Donec ullamcorper nulla non metus auctor fringilla. Maecenas faucibus mollis interdum. Nulla vitae elit libero, a pharetra augue.</p>
			</div>
		</div>
		<div class="div"></div>
		<div class="column row">
			<div class="stats-container">
				<div class="stat stat--red">
					<h2 class="stat__heading">Top 25</h2>
					<div class="stat__body">
						<p>Vestibulum id ligula porta felis euismod semper. Integer posuere erat a ante venenatis dapibus.</p>
					</div>
				</div>
				<div class="stat stat--blue stat--growtwo">
					<h2 class="stat__heading">96% <span>Placement</span></h2>
					<div class="stat__body">
				...
				<div class="stat stat--orange">
					<h2 class="stat__heading">Top 12</h2>
					<div class="stat__body">
						<p>Vestibulum id ligula porta felis euismod semper. Nullam quis risus eget urna mollis ornare vel eu leo.</p>
					</div>
				</div>
				<div class="stat stat--black stat--growtwo">
					<h2 class="stat__heading">#2 <span>for Counseling</h2>
					<div class="stat__body">
				...
				<div class="stat stat--gray">
					<h2 class="stat__heading">9th <span>in Nation</span></h2>
					<div class="stat__body">
						<p>Aenean lacinia bibendum nulla sed consectetur. Cras mattis consectetur purus sit amet fermentum.</p>
					</div>
				</div>
				<div class="stat stat--teal">
					<h2 class="stat__heading">36</h2>
					<div class="stat__body">
						<p>Women attended a 5 day residential leadership training institute where they receive over 40 hours of training on leadership.</p>
					</div>
				</div>
				<div class="stat stat--blue">
					<h2 class="stat__heading">6th <span>Highest</span></h2>
					<div class="stat__body">
						<p>Aenean lacinia bibendum nulla sed consectetur. Cras mattis consectetur purus sit amet fermentum.</p>
					</div>
				</div>
				<div class="stat stat--orange stat--growthree">
					<h2 class="stat__heading">#2 <span>For Business</span></h2>
					<div class="stat__body">
						<p>Aenean lacinia bibendum nulla sed consectetur. Cras mattis consectetur purus sit amet fermentum.</p>
					</div>
				</div>
				<div class="stat stat--teal">
					<h2 class="stat__heading">94% <span>Retention</span></h2>
					<div class="stat__body">
						<p>Aenean lacinia bibendum nulla sed consectetur. Cras mattis consectetur purus sit amet fermentum.</p>
					</div>
				</div>
				<div class="stat stat--gray stat--growtwo">
					<h2 class="stat__heading">26 <span>Sports</span></h2>
					<div class="stat__body">
						<p>Aenean lacinia bibendum nulla sed consectetur. Cras mattis consectetur purus sit amet fermentum.</p>
					</div>
				</div>
				<div class="stat stat--black">
					<h2 class="stat__heading">13th <span>in Nation</span></h2>
					<div class="stat__body">
						<p>Aenean lacinia bibendum nulla sed consectetur. Cras mattis consectetur purus sit amet fermentum.</p>
					</div>
				</div>
