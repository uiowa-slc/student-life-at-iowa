    ...
    <div class="stats">
        ...
        <div class="stats__box stats__box--span2">
            <div class="stats__inner">
                ...
                <span class="stats__label">Total Visits</span>
                <span class="stats__copy">Total visits to recreational facilities</span>
            </div>
        </div>
        <div class="stats__box">
            <div class="stats__inner">
                <span class="stats__num">2,298</span>
                <span class="stats__label">Total Students</span>
        ...
        <div class="stats__box">
            <div class="stats__inner">
                ...
                <span class="stats__copy">Total visits to the Cultural Centers in spring 2019</span>
            </div>
        </div>
        <div class="stats__box">
            <div class="stats__inner">
        ...
        <div class="stats__box">
            <div class="stats__inner">
                ...
                <span class="stats__copy">Students served through Hawkeye Meal Share</span>
            </div>
        </div>
        <div class="stats__box">
            <div class="stats__inner">
                <span class="stats__num stats__num--lg">8,239</span>
                <span class="stats__label">Reservations</span>
                <span class="stats__copy">IMU reservations by student organizations</span>
            </div>
        </div>
        <div class="stats__box">
            <div class="stats__inner">
