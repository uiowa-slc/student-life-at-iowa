    ...
    <div class="row">
        <article role="main" class="main-content main-content--with-padding <% if $Children || $Menu(2) || $SidebarArea.Elements ||  $SidebarView.Widgets %>main-content--with-sidebar<% else %>main-content--full-width<% end_if %>">
            ...
            <div class="main-content__text">
                <% if $FeaturedImage %>
                    <img class="featured-image" src="$FeaturedImage.ScaleWidth(860).URL" loading="lazy"<% if $FeaturedImageAltText %> alt="$FeaturedImageAltText" <% else %> alt="" role="presentation" <% end_if %> width="840" height="$FeaturedImage.ScaleWidth(860).Height" />
